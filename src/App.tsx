  ...
  return (
    <div className="min-h-screen flex flex-col">
      <div className="px-6 py-3 flex items-center justify-between border-b">
        <h1 className="text-xl font-bold tracking-wide"><span className="text-primary">upload</span>.ai</h1>
      ...
      <main className="flex-1 p-6 flex gap-6">
        ...
        <aside className="w-80 space-y-6">
          <form className="space-y-6">
            <label 
              htmlFor="video" 
              className="border w-full aspect-video flex rounded-md items-center justify-center cursor-pointer border-dashed text-sm flex-col gap-2 text-muted-foreground hover:bg-white/5">
